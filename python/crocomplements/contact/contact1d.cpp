...
void exposeContact1D() {
  ...
  bp::class_<sobec::newcontacts::ContactModel1D,
      ...
      .def(bp::init<boost::shared_ptr<crocoddyl::StateMultibody>,
          ...
          "np.matrix([0.,0.]))\n"
          ":param type: reference type of contact\n"))
      .def("calc", &sobec::newcontacts::ContactModel1D::calc,
           bp::args("self", "data", "x"),
      ...
      .def("calcDiff", &sobec::newcontacts::ContactModel1D::calcDiff,
           bp::args("self", "data", "x"),
           ...
           ":param x: state point (dim. state.nx)")
      .def("updateForce", &sobec::newcontacts::ContactModel1D::updateForce,
           bp::args("self", "data", "force"),
           "Convert the force into a stack of spatial forces.\n\n"
           ":param data: cost data\n"
           ":param force: force vector (dimension 1)")
      .def("createData", &sobec::newcontacts::ContactModel1D::createData,
      ...
      .add_property(
          "reference",
          bp::make_function(&sobec::newcontacts::ContactModel1D::get_reference,
                            bp::return_internal_reference<>()),
          &sobec::newcontacts::ContactModel1D::set_reference,
          "reference contact translation")
      .add_property(
          "gains",
          bp::make_function(&sobec::newcontacts::ContactModel1D::get_gains,
                            bp::return_value_policy<bp::return_by_value>()),
          "contact gains")
      .add_property(
          "mask",
          bp::make_function(&sobec::newcontacts::ContactModel1D::get_mask,
                            bp::return_value_policy<bp::return_by_value>()),
          &sobec::newcontacts::ContactModel1D::set_mask, "mask")
      .add_property(
          "type",
          bp::make_function(&sobec::newcontacts::ContactModel1D::get_type,
                            bp::return_value_policy<bp::return_by_value>()),
          &sobec::newcontacts::ContactModel1D::set_type, "type");

  bp::register_ptr_to_python<
      boost::shared_ptr<sobec::newcontacts::ContactData1D> >();

  bp::class_<sobec::newcontacts::ContactData1D,
             bp::bases<crocoddyl::ContactData1D> >(
      "sobec::newcontacts::ContactData1D", "Data for 1D contact.\n\n",
      bp::init<sobec::newcontacts::ContactModel1D*, pinocchio::Data*>(
      ...
      .add_property(
          "v",
          bp::make_getter(&sobec::newcontacts::ContactData1D::v,
                          bp::return_value_policy<bp::return_by_value>()),
          "spatial velocity of the contact body")
      .add_property(
          "a",
          bp::make_getter(&sobec::newcontacts::ContactData1D::a,
                          bp::return_value_policy<bp::return_by_value>()),
          "spatial acceleration of the contact body")
      .add_property("fJf",
                    bp::make_getter(&sobec::newcontacts::ContactData1D::fJf,
                                    bp::return_internal_reference<>()),
                    "local Jacobian of the contact frame")
      .add_property(
          "v_partial_dq",
          bp::make_getter(&sobec::newcontacts::ContactData1D::v_partial_dq,
                          bp::return_internal_reference<>()),
          "Jacobian of the spatial body velocity")
      .add_property(
          "a_partial_dq",
          bp::make_getter(&sobec::newcontacts::ContactData1D::a_partial_dq,
                          bp::return_internal_reference<>()),
          "Jacobian of the spatial body acceleration")
      .add_property(
          "a_partial_dv",
          bp::make_getter(&sobec::newcontacts::ContactData1D::a_partial_dv,
                          bp::return_internal_reference<>()),
          "Jacobian of the spatial body acceleration")
      .add_property(
          "a_partial_da",
          bp::make_getter(&sobec::newcontacts::ContactData1D::a_partial_da,
                          bp::return_internal_reference<>()),
          "Jacobian of the spatial body acceleration")
      .add_property(
          "oRf",
          bp::make_getter(&sobec::newcontacts::ContactData1D::oRf,
                          bp::return_internal_reference<>()),
          "Rotation matrix of the contact body expressed in the world frame")
      .add_property(
          "drnea_skew_term",
          bp::make_getter(&sobec::newcontacts::ContactData1D::drnea_skew_term_,
                          bp::return_internal_reference<>()),
