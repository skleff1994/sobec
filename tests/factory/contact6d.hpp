...
#ifndef SOBEC_CONTACT_6D_FACTORY_HPP_
#define SOBEC_CONTACT_6D_FACTORY_HPP_
...
class ContactModel6DFactory {
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW

  explicit ContactModel6DFactory();
...
#endif  // SOBEC_CONTACT_6D_FACTORY_HPP_
