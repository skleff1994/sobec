...
template <typename Scalar>
void DifferentialActionModelSoftContact1DFwdDynamicsTpl<Scalar>::set_force_cost(const Scalar force_des, 
...
template <typename Scalar>
void DifferentialActionModelSoftContact1DFwdDynamicsTpl<Scalar>::set_Kp(const Scalar inKp) {
  if (inKp < 0.) {
    throw_pretty("Invalid argument: "
...
template <typename Scalar>
void DifferentialActionModelSoftContact1DFwdDynamicsTpl<Scalar>::set_Kv(const Scalar inKv) {
  if (inKv < 0.) {
    throw_pretty("Invalid argument: "
...
template <typename Scalar>
void DifferentialActionModelSoftContact1DFwdDynamicsTpl<Scalar>::set_oPc(const Vector3s& inoPc) {
  if (inoPc.size() != 3) {
    throw_pretty("Invalid argument: "
...
template <typename Scalar>
void DifferentialActionModelSoftContact1DFwdDynamicsTpl<Scalar>::set_force_weight(const Scalar inForceWeight) {
  if (inForceWeight < 0.) {
    throw_pretty("Invalid argument: "
...
template <typename Scalar>
void DifferentialActionModelSoftContact1DFwdDynamicsTpl<Scalar>::set_ref(const pinocchio::ReferenceFrame inRef) {
  ref_ = inRef;
}

template <typename Scalar>
void DifferentialActionModelSoftContact1DFwdDynamicsTpl<Scalar>::set_id(const pinocchio::FrameIndex inId) {
  frameId_ = inId;
}

template <typename Scalar>
const Scalar DifferentialActionModelSoftContact1DFwdDynamicsTpl<Scalar>::get_Kp() const {
  return Kp_;
}

template <typename Scalar>
const Scalar DifferentialActionModelSoftContact1DFwdDynamicsTpl<Scalar>::get_Kv() const {
  return Kv_;
}

template <typename Scalar>
const typename MathBaseTpl<Scalar>::Vector3s& DifferentialActionModelSoftContact1DFwdDynamicsTpl<Scalar>::get_oPc() const {
  return oPc_;
}
...
template <typename Scalar>
const Scalar DifferentialActionModelSoftContact1DFwdDynamicsTpl<Scalar>::get_force_weight() const {
  return force_weight_;
}

template <typename Scalar>
const pinocchio::ReferenceFrame& DifferentialActionModelSoftContact1DFwdDynamicsTpl<Scalar>::get_ref() const {
  return ref_;
}

template <typename Scalar>
const pinocchio::FrameIndex& DifferentialActionModelSoftContact1DFwdDynamicsTpl<Scalar>::get_id() const {
  return frameId_;
}
